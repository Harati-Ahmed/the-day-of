...
export default function SEO({ data }: SEOProps) {
  ...
  return (
    <Head>
      ...
      <meta property="og:image" content="https://www.thedayof.net/images/og-default.svg" />
      ...
      <meta name="twitter:image" content="https://www.thedayof.net/images/og-default.svg" />
